                  ...
                  <section className="informacion-modal">
                    ...
                    <article className="infoBasica-modal">
                      <div className="texto">
                        ...
                        <p className="info-modal"><b>Descripción:</b> Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga, rerum fugiat! Temporibus officiis magni molestias repellat reprehenderit. Aperiam recusandae labore aspernatur distinctio consectetur aut placeat laudantium. Ex quod fugit eligendi.</p>
                      </div>
                      <section className="local-calendario">
